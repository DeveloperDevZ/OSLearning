...
from __future__ import print_function #Permits the use of new Python syntax, even in old Python
import sys #This enables line processing in the terminal 
from optparse import OptionParser #Automatically handles parsing command line inputs 
import random #Enables random and probabilistic functions 
...
parser = OptionParser() #Initiate an instance of the OptionParser class 
#Specified parser options added to the parser object 
...
(options, args) = parser.parse_args() #Stores the returned values/objects from the parser object 
...
import operator #Provides various operators as functions 

joblist = [] #Empty list of jobs 
if options.jlist == '':
